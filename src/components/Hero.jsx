        ...
        <div>
          <div className="flex items-center mb-2.5">
            ...
            <p className="text-[15px]  font-SFmedium tracking-wide max-lg:text-sm">
              ...
              <span className="font-SFlight text-sm max-lg:text-xs text-[#0066cc]">
                Ask a Specialist
              </span>
            </p>
          </div>
          <div className="flex items-center">
            ...
            <p className="text-[15px]  font-SFmedium tracking-wide max-lg:text-sm">
              ...
              <span className="font-SFlight text-sm text-[#0066cc] max-lg:text-xs">
                Find one near you
              </span>
            </p>
          </div>
          ...
          return (
            <div key={index} className="flex flex-col items-center max-lg:px-5">
              <img
                ...
                width={200}
                height={130}
                className="pb-4 w-auto max-h-24"
              />
